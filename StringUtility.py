class StringUtility:
  def __init__(self, string):
	...
	args: (str) Stores the string in a new object.
	return: None
    '''
    self.string = string
  ...
  def __str__(self):
	...
	args: None
	return: (str) Returns the string value of the object
    '''
    return self.string
  ...
  def vowels(self):
	...
	args: None
	return: (str) Returns a string that contains the number of vowels in the given string
    '''
  ...
  def bothEnds(self):
	...
	args: None
	return: (str) Returns a new string that is the frist and last two letter of a given string
    '''
  ...
  def fixStart(self):
	...
	args: None
	return: (str) Returns a new string that got every letter that's the same as the first letter to *
    '''
  ...
  def asciiSum(self):
	...
	args: None
	return: (int) Returns a interger that is the sum of the ascii numbers
    '''
  ...
  def cipher(self):  
	...
	args: None
	return: (str) Returns a new string that is shifted
    '''
    newString = ""
